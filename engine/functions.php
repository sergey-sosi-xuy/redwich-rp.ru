...
function EncodeGunSkills($skills,$symbol){
	return sscanf($skills, "%d$symbol%d$symbol%d$symbol%d$symbol%d$symbol%d$symbol%d");
}
function EncodeLicence($skills,$symbol){
	return sscanf($skills, "%d$symbol%d$symbol%d$symbol%d$symbol%d$symbol%d$symbol%d$symbol%d");
}
