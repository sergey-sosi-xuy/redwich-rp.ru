          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="inner-container">
              ...
              <div class="inner-body inner-border clearfix">
                <div class="player-skin pull-left"><div class='user_img' style='background:url(/public/main/img/skins/<?=$data[$ucp_table_settings['skin']];?>.png) -15px top;height:100px;border-radius: 300px;'></div></div>
                <div class="player-info pull-left">
                  <h2><?FixName($data[$ucp_table_settings['name']])?></h2>
              ...
              <div class="inner-body inner-border">
                <table class="player-stat">
                  ...
                  <tr>
                    <td>Проживание:</td>
                    <td>дом <?=($data[$ucp_table_settings['house']] != -1)?"#".$data[$ucp_table_settings['house']]:"Отсутствует";?></td>
                  </tr>
