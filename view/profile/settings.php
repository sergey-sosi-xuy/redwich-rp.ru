...
<head>
	...
	<!-- Data table CSS -->
	<link href="/public/bower_components/datatables/media/css/jquery.dataTables.min.css" rel="stylesheet"
		type="text/css" />

	<!-- Toast CSS -->
	<link href="/public/bower_components/jquery-toast-plugin/dist/jquery.toast.min.css" rel="stylesheet"
		type="text/css">
										...
										<div class="col-sm-12 col-xs-12">
											<div class="form-wrap">
												<form class="form-horizontal" method="POST"
													action="/engine/obr/profile.php">

													<div class="form-group">
														<label for="exampleInputpwd_32"
															class="col-sm-3 control-label">Введите новый пароль</label>
														<div class="col-sm-9">
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-lock"></i>
																</div>
																<input type="password" class="form-control"
																	name="new_password_1" id="exampleInputpwd_32"
													...
													<div class="form-group">
														<label for="exampleInputpwd_32"
															class="col-sm-3 control-label">Повторите новый
															пароль</label>
														<div class="col-sm-9">
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-lock"></i>
																...
																<input type="password" class="form-control"
																	name="new_password_2" id="exampleInputpwd_32"
					...
					Подайте заявку в White List чтобы создавать персонажей! </div>' ):?>
										...
										<form method="POST" action="/engine/obr/profile.php">
											...
											<div class="form-group mb-0">
												<div class=" col-sm-12">
													<button type="submit"
														class="btn btn-block  btn-success">Принять</button>
												</div>
											</div>
