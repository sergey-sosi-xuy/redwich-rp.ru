					...
					<div class="adv-wrap" data-aos="zoom-in" data-aos-duration="1500">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="adv-item">
								...
								<div class="adv-text"><p>Наш проект один из самых популярных проектов CRMP индустрии!</p></div>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="adv-item">
			...
			<div class="container">
				<div class="row">
					<div class="social-wrap" data-aos="fade-up" data-aos-duration="1500">
						...
						<div class="s-button">
							<center><a href="<?=$ucp_settings['s_vk']?>" class="btn btn-s">Сообщество ВКонтакте</a></center>
						</div>
					</div>
				</div>
			</div>
